...
from app.auth.forms import LoginForm, EditProfileForm, EmptyForm, PostForm
from app.auth.forms import ResetPasswordRequestForm, ResetPasswordForm, RegistrationForm
...
def index():
    ...
    return render_template('index.html', title='Home Page', posts=posts,
                           user=current_user, form=form, next_url=next_url,
                           prev_url=prev_url)
